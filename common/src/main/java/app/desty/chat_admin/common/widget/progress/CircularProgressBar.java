package app.desty.chat_admin.common.widget.progress;
...
public class CircularProgressBar extends ProgressBar {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final boolean capRound = a.getBoolean(R.styleable.CircularProgressBar_cpb_cap_round, true);
        a.recycle();
        ...
        CircularProgressDrawable.Builder builder = new CircularProgressDrawable.Builder(context)
                ...
                .maxSweepAngle(maxSweepAngle).style(capRound
                                                    ? CircularProgressDrawable.Style.ROUNDED
                                                    : CircularProgressDrawable.Style.NORMAL);
