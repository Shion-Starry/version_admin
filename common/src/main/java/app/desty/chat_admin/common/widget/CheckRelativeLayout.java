...
/**
 * 支持check状态的相对布局，check状态改变时会同步到支持check的子类中
 */
public class CheckRelativeLayout extends RelativeLayout implements Checkable {
    ...
    public CheckRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CheckRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public CheckRelativeLayout setOnCheckChangeListener(
    ...
    public CheckRelativeLayout setTouchable(boolean touchable) {
    ...
    public static void touchable(CheckRelativeLayout view, boolean touchable) {
        view.setTouchable(touchable);
    }

    @BindingAdapter("checked")
    public static void setChecked(CheckRelativeLayout view, boolean check) {
        if (view != null) {
    ...
    public static boolean isChecked(CheckRelativeLayout view) {
        if (view == null) return false;
        return view.isChecked();
    }

    @BindingAdapter(value = "checkedAttrChanged")
    public static void setChangeListener(CheckRelativeLayout view, InverseBindingListener listener) {
