...
public class ClearFocusLinearLayout extends LinearLayout {
    ...
    public ClearFocusLinearLayout(@NonNull Context context) {
        super(context);
    }
    ...
    public ClearFocusLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
