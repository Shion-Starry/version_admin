...
/**
 * 使用databinding取代drawable实现各种shape，selector
 */
...
public class DrawablesBindingAdapter {
    ...
    @BindingAdapter(value = {
            ...
            "drawable_disabled_shapeMode",
            "drawable_disabled_solidColor",
            "drawable_disabled_strokeColor",
            "drawable_disabled_strokeWidth",
            "drawable_disabled_strokeDash",
            "drawable_disabled_strokeDashGap",
            "drawable_disabled_radius",
            "drawable_disabled_radiusLT",
            "drawable_disabled_radiusLB",
            "drawable_disabled_radiusRT",
            "drawable_disabled_radiusRB",
            "drawable_disabled_startColor",
            "drawable_disabled_centerColor",
            "drawable_disabled_endColor",
            "drawable_disabled_orientation",
            "drawable_disabled_gradientType",
            "drawable_disabled_radialCenterX",
            "drawable_disabled_radialCenterY",
            "drawable_disabled_radialRadius",
            "drawable_disabled_width",
            "drawable_disabled_height",
            "drawable_disabled_marginLeft",
            "drawable_disabled_marginTop",
            "drawable_disabled_marginRight",
            "drawable_disabled_marginBottom",
            "drawable_disabled_ringThickness",
            "drawable_disabled_ringThicknessRatio",
            "drawable_disabled_ringInnerRadius",
            "drawable_disabled_ringInnerRadiusRatio",
    ...
    public static void setViewBackground(
            ...
            @ShapeMode int disabled_shapeMode,
            @ColorInt Integer disabled_solidColor,
            @ColorInt int disabled_strokeColor,
            float disabled_strokeWidth,
            float disabled_strokeDash,
            float disabled_strokeDashGap,
            float disabled_radius,
            float disabled_radiusLT,
            float disabled_radiusLB,
            float disabled_radiusRT,
            float disabled_radiusRB,
            @ColorInt Integer disabled_startColor,
            @ColorInt Integer disabled_centerColor,
            @ColorInt Integer disabled_endColor,
            @Orientation int disabled_orientation,
            @GradientType int disabled_gradientType,
            Float disabled_radialCenterX,
            Float disabled_radialCenterY,
            float disabled_radialRadius,
            float disabled_width,
            float disabled_height,
            float disabled_marginLeft,
            float disabled_marginTop,
            float disabled_marginRight,
            float disabled_marginBottom,
            float disabled_ringThickness,
            float disabled_ringThicknessRatio,
            float disabled_ringInnerRadius,
            float disabled_ringInnerRadiusRatio,
        ...
        int count = 0;
        Drawable defaultDrawable = drawable != null
                                   ? drawable
                                   : create(
                                           shapeMode,
                                           solidColor,
        ...
        Drawable checkedDrawable = drawable_checked != null
                                   ? drawable_checked
                                   : create(
                                           checked_shapeMode,
                                           checked_solidColor,
        ...
        Drawable checkableDrawable = drawable_checkable != null
                                     ? drawable_checkable
                                     : create(
                                             checkable_shapeMode,
        ...
        Drawable enabledDrawable = drawable_enabled != null
                                   ? drawable_enabled
                                   : create(
                                           enabled_shapeMode,
                                           enabled_solidColor,
        ...
        Drawable disabledDrawable = drawable_disabled != null
                                    ? drawable_disabled
                                    : create(
                                            disabled_shapeMode,
                                            disabled_solidColor,
                                            disabled_strokeColor,
                                            disabled_strokeWidth,
                                            disabled_strokeDash,
                                            disabled_strokeDashGap,
                                            disabled_radius,
                                            disabled_radiusLT,
                                            disabled_radiusLB,
                                            disabled_radiusRT,
                                            disabled_radiusRB,
                                            disabled_startColor,
                                            disabled_centerColor,
                                            disabled_endColor,
                                            disabled_orientation,
                                            disabled_gradientType,
                                            disabled_radialCenterX,
                                            disabled_radialCenterY,
                                            disabled_radialRadius,
                                            disabled_width,
                                            disabled_height,
                                            disabled_marginLeft,
                                            disabled_marginTop,
                                            disabled_marginRight,
                                            disabled_marginBottom,
                                            disabled_ringThickness,
                                            disabled_ringThicknessRatio,
                                            disabled_ringInnerRadius,
                                            disabled_ringInnerRadiusRatio
                                    );
        if (disabledDrawable != null) {
            count++;
        }
        Drawable focusedDrawable = drawable_focused != null
                                   ? drawable_focused
                                   : create(
                                           focused_shapeMode,
                                           focused_solidColor,
        ...
        Drawable pressedDrawable = drawable_pressed != null
                                   ? drawable_pressed
                                   : create(
                                           pressed_shapeMode,
                                           pressed_solidColor,
        ...
        Drawable selectedDrawable = drawable_selected != null
                                    ? drawable_selected
                                    : create(
                                            selected_shapeMode,
                                            selected_solidColor,
            ...
            if (count == 1 && !isDefaultNull) {
                ...
                if (checkableDrawable != null) {
                    listDrawable.addState(new int[]{
                            android.R.attr.state_checkable}, checkableDrawable);
                }
                if (focusedDrawable != null) {
                ...
                if (selectedDrawable != null) {
                    listDrawable.addState(new int[]{
                            android.R.attr.state_selected}, selectedDrawable);
                }
                if (disabledDrawable != null) {
                    listDrawable.addState(new int[]{
                            -android.R.attr.state_enabled}, disabledDrawable);
                }
                if (enabledDrawable != null) {
    ...
    @BindingAdapter(value = {"textColor",
                             ...
                             "textSelectedColor"}
            , requireAll = false)
    public static void setTextColor(View textView,
                                    @ColorInt Integer textColor,
                                    @ColorInt Integer textCheckedColor,
                                    @ColorInt Integer textCheckableColor,
                                    @ColorInt Integer textDisabledColor,
                                    @ColorInt Integer textFocusedColor,
                                    @ColorInt Integer textPressedColor,
                                    @ColorInt Integer textSelectedColor) {
        if (!(textView instanceof TextView)) return;

        int[][] states = new int[7][1]; // 控件状态列表
        int[] colors = new int[7];
        int index = 0;
        if (textDisabledColor != null) {
            states[index] = new int[]{-android.R.attr.state_enabled};
            colors[index] = textDisabledColor;
            index++;
        }
        if (textPressedColor != null) {
            states[index] = new int[]{android.R.attr.state_pressed};
            colors[index] = textPressedColor;
            index++;
        }
        if (textCheckedColor != null) {
            states[index] = new int[]{android.R.attr.state_checked};
            colors[index] = textCheckedColor;
            index++;
        }
        if (textSelectedColor != null) {
            states[index] = new int[]{android.R.attr.state_selected};
            colors[index] = textSelectedColor;
            index++;
        }
        if (textFocusedColor != null) {
            states[index] = new int[]{android.R.attr.state_focused};
            colors[index] = textFocusedColor;
            index++;
        }
        if (textCheckableColor != null) {
            states[index] = new int[]{android.R.attr.state_checkable};
            colors[index] = textCheckableColor;
            index++;
        }
        if (textColor != null) {
            states[index] = new int[]{0};
            colors[index] = textColor;
            index++;
        }
        if (index > 0) {
    ...
    @BindingAdapter(value = {"srcRes", "tint"}, requireAll = false)
    public static void setImageSrcRes(View view, @DrawableRes Integer srcRes,
                                      @ColorInt Integer tintColor) {

        if (!(view instanceof ImageView)) return;
        ImageView imageView = (ImageView) view;
        if(srcRes==null || srcRes==0){
    ...
    // normal, checked, checkable, enabled, focused, pressed, selected
    @BindingAdapter(value = {"normalSrc", "normalTint",
                             "checkedSrc", "checkedTint",
                             "checkableSrc", "checkableTint",
                             "disabledSrc", "disabledTint",
                             "focusedSrc", "focusedTint",
                             "pressedSrc", "pressedTint",
                             "selectedSrc", "selectedTint"}
            , requireAll = false)
    public static void setImageSrc(View imageView,
                                   Drawable normalSrc, @ColorInt Integer normalTint,
                                   Drawable checkedSrc, @ColorInt Integer checkedTint,
                                   Drawable checkableSrc, @ColorInt Integer checkableTint,
                                   Drawable disabledSrc, @ColorInt Integer disabledTint,
                                   Drawable focusedSrc, @ColorInt Integer focusedTint,
                                   Drawable pressedSrc, @ColorInt Integer pressedTint,
                                   Drawable selectedSrc, @ColorInt Integer selectedTint) {
        if (!(imageView instanceof ImageView)) return;
        ProxyDrawable listDrawable = new ProxyDrawable();
        if (checkedSrc != null) {
            if (checkedTint != null) checkedSrc.setTint(checkedTint);
            listDrawable.addState(new int[]{android.R.attr.state_checked}, checkedSrc);
        }
        if (checkableSrc != null) {
            if (checkableTint != null) checkableSrc.setTint(checkableTint);
            listDrawable.addState(new int[]{android.R.attr.state_checkable}, checkableSrc);
        }
        if (disabledSrc != null) {
            if (disabledTint != null) disabledSrc.setTint(disabledTint);
            listDrawable.addState(new int[]{-android.R.attr.state_enabled}, disabledSrc);
        }
        if (focusedSrc != null) {
            if (focusedTint != null) focusedSrc.setTint(focusedTint);
            listDrawable.addState(new int[]{android.R.attr.state_focused}, focusedSrc);
        }
        if (pressedSrc != null) {
            if (pressedTint != null) pressedSrc.setTint(pressedTint);
            listDrawable.addState(new int[]{android.R.attr.state_pressed}, pressedSrc);
        }
        if (selectedSrc != null) {
            if (selectedTint != null) selectedSrc.setTint(selectedTint);
            listDrawable.addState(new int[]{android.R.attr.state_selected}, selectedSrc);
        }
        if (normalSrc != null) {
            if (normalTint != null) normalSrc.setTint(normalTint);
            listDrawable.addState(new int[]{}, normalSrc);
        }
        ((ImageView) imageView).setImageDrawable(listDrawable);
    }

    public static Drawable create(
            @ShapeMode int shapeMode, @ColorInt Integer solidColor,
            @ColorInt int strokeColor, @DP float strokeWidth, @DP float strokeDash,
            @DP float strokeDashGap,
            @DP float radius, @DP float radiusLT, @DP float radiusLB, @DP float radiusRT,
            @DP float radiusRB,
            ...
            @DP float marginLeft, @DP float marginTop, @DP float marginRight,
            @DP float marginBottom,
        ...
        if (startColor != null && endColor != null) {
            ...
            if (gradientType == GradientType.RADIAL) {
                drawable.setGradientCenter(radialCenterX == null
                                           ? .5f
                                           : radialCenterX,
                                           radialCenterY == null
                                           ? .5f
        ...
        if (radius <= 0) {
            float[] radiusEach = new float[]{dip2px(radiusLT), dip2px(radiusLT), dip2px(radiusRT),
                                             dip2px(radiusRT),
                                             dip2px(radiusRB), dip2px(radiusRB), dip2px(radiusLB),
                                             dip2px(radiusLB)};
